!(function (t, e) {
    ...
    function _(t, e, n) {
        ...
        if (
            ...
            if ("string" != typeof e.customClass[n] && !e.customClass[n].forEach)
                return z("Invalid type of customClass.".concat(n, '! Expected string or iterable object, got "').concat(r(e.customClass[n]), '"'))
    ...
    function pt(t) {
        mn.isVisible() && ht !== t.target.value && mn.resetValidationMessage(), (ht = t.target.value)
    }
    function ft(t, e) {
        t instanceof HTMLElement ? e.appendChild(t) : "object" === r(t) ? kt(t, e) : t && N(e, t)
    }
    function mt(t, e) {
        var n = j(),
            o = T(),
    ...
    var ht,
        ...
        Ct = function (t) {
            var e,
                ...
                g =
                    !!(e = J()) &&
                    (e.parentNode.removeChild(e), vt([document.documentElement, document.body], [Q["no-backdrop"], Q["toast-shown"], Q["has-column"]]), !0)
            dt()
    ...
    function Pt(t, e, n) {
        var o
        ct(t, n["show".concat((o = e).charAt(0).toUpperCase() + o.slice(1), "Button")], "inline-block"),
    ...
    function At(t, e) {
        ...
        l &&
            ((n = l),
            "string" == typeof (o = e.backdrop) ? (n.style.background = o) : o || gt([document.documentElement, document.body], Q["no-backdrop"]),
            !e.backdrop && e.allowOutsideClick && z('"allowOutsideClick" parameter requires `backdrop` parameter to be set to `true`'),
            (i = l),
            (r = e.position) in Q ? gt(i, Q[r]) : (z('The "position" parameter is not valid, defaulting to "center"'), gt(i, Q.center)),
            (a = l),
            !(c = e.grow) || "string" != typeof c || ((s = "grow-".concat(c)) in Q && gt(a, Q[s])),
            _(l, e, "container"),
            (u = document.body.getAttribute("data-swal2-queue-step")) &&
                (l.setAttribute("data-queue-step", u), document.body.removeAttribute("data-swal2-queue-step")))
    }
    function St(t, e) {
    ...
    ;(It.text = It.email = It.password = It.number = It.tel = It.url = function (t, e) {
        return (
            "string" == typeof e.inputValue || "number" == typeof e.inputValue
                ...
                : b(e.inputValue) || z('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(r(e.inputValue), '"')),
            St(t, e),
            (t.type = e.input),
            t
        )
        ...
        (It.select = function (t, e) {
            ...
            return (
                (t.textContent = ""),
                e.inputPlaceholder &&
                    ((n = document.createElement("option")), N(n, e.inputPlaceholder), (n.value = ""), (n.disabled = !0), (n.selected = !0), t.appendChild(n)),
                t
            )
        }),
        (It.radio = function (t) {
        ...
        (It.textarea = function (e, t) {
            ...
            return (
                ...
                "MutationObserver" in window &&
                    ...
                    (o = parseInt(window.getComputedStyle(X()).paddingLeft) + parseInt(window.getComputedStyle(X()).paddingRight)),
    ...
    function Mt(t, e) {
        ...
        e.html ? (ft(e.html, c), rt(c, "block")) : e.text ? ((c.textContent = e.text), rt(c, "block")) : at(c),
            (n = t),
            (o = e),
            (i = x()),
    ...
    function Dt(t, s) {
        ...
        l >= s.progressSteps.length &&
            z("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"),
            s.progressSteps.forEach(function (t, e) {
                var n,
                    ...
                    r,
                    a,
                    c = ((n = t), (o = document.createElement("li")), gt(o, Q["progress-step"]), N(o, n), o)
                u.appendChild(c),
                ...
                : (Ut(),
                  o.icon &&
                      (-1 !== Object.keys($).indexOf(o.icon)
                          ? ((i = C(".".concat(Q.icon, ".").concat($[o.icon]))), rt(i), Ft(i, o), _t(), _(i, o, "icon"), gt(i, o.showClass.icon))
                          : W('Unknown icon! Expected "success", "error", "warning", "info" or "question", got "'.concat(o.icon, '"')))),
            (function (t) {
                var e = P()
    ...
    var Ut = function () {
        ...
        Wt = [],
        Kt = function (t, e) {
            ;(t.className = "".concat(Q.popup, " ").concat(bt(t) ? e.showClass.popup : "")),
                e.toast ? (gt([document.documentElement, document.body], Q["toast-shown"]), gt(t, Q.toast)) : gt(t, Q.modal),
                _(t, e, "popup"),
        ...
        return new Promise(function (t) {
            ...
            ;(te.restoreFocusTimeout = setTimeout(function () {
                te.previousActiveElement && te.previousActiveElement.focus
                    ? (te.previousActiveElement.focus(), (te.previousActiveElement = null))
    ...
    function Gt(t) {
        for (var e in t)
            Jt((i = e)) || z('Unknown parameter "'.concat(i, '"')),
                t.toast && ((o = e), -1 !== ie.indexOf(o) && z('The parameter "'.concat(o, '" is incompatible with toasts'))),
                Xt((n = e)) && g(n, Xt(n))
        var n, o, i
    }
    var te = {},
                ...
                return (
                    "object" !== r(o[0]) || w(o[0])
                        ? ["title", "html", "icon"].forEach(function (t, e) {
                              ...
                              "string" == typeof n || w(n)
                                  ? (i[t] = n)
                                  : void 0 !== n && W("Unexpected type of ".concat(t, '! Expected "string" or "Element", got ').concat(r(n)))
                          })
                        : s(i, o[0]),
                    i
                )
    ...
    function ae() {
        ...
        e &&
            ...
            at(t.loader),
            e.showConfirmButton ? rt(t.confirmButton) : e.showConfirmButton || e.showCancelButton || at(t.actions),
    ...
    var le = function () {
            navigator.userAgent.match(/(CriOS|FxiOS|EdgiOS|YaBrowser|UCBrowser)/i) ||
                (X().scrollHeight > window.innerHeight - 44 && (J().style.paddingBottom = "".concat(44, "px")))
        },
        de = function () {
            var e,
                t = J()
        ...
        pe = function (t) {
            var e = J()
            return t === e || !(st(e) || "INPUT" === t.tagName || (st(x()) && x().contains(t)))
        },
    ...
    function me(t, e, n, o) {
        ...
        n
            ...
            H() &&
                (null !== tt.previousBodyPadding &&
                    ((document.body.style.paddingRight = "".concat(tt.previousBodyPadding, "px")), (tt.previousBodyPadding = null)),
                U(document.body, Q.iosfix) &&
                    ((i = parseInt(document.body.style.top, 10)),
                    vt(document.body, Q.iosfix),
                    (document.body.style.top = ""),
                    (document.body.scrollTop = -1 * i)),
                "undefined" != typeof window && se() && window.removeEventListener("resize", ue),
            ...
            vt([document.documentElement, document.body], [Q.shown, Q["height-auto"], Q["no-backdrop"], Q["toast-shown"], Q["toast-column"]])
    }
    function he(t) {
        var e,
            n,
        ...
        i &&
            ((t = (function (t) {
                return void 0 !== t ? s({ isConfirmed: !1, isDenied: !1, isDismissed: !1 }, t) : { isConfirmed: !1, isDenied: !1, isDismissed: !0 }
            })(t)),
            (e = Et.innerParams.get(this)) &&
    ...
    function ke(t) {
        ...
        ;(e = t).inputValidator ||
            ...
            ((n = t).target && ("string" != typeof n.target || document.querySelector(n.target)) && ("string" == typeof n.target || n.target.appendChild)) ||
                (z('Target parameter is not valid, defaulting to "body"'), (n.target = "body")),
    ...
    function Pe(t, e) {
        "select" === e.input || "radio" === e.input
            ? Re(t, e)
            : -1 !== ["text", "email", "number", "tel", "textarea"].indexOf(e.input) && (v(e.inputValue) || b(e.inputValue)) && Ne(t, e)
    }
    function Ae(t, e) {
    ...
    var qe = function (t, e) {
            xt && ut(e) ? ((t.style.overflowY = "hidden"), e.addEventListener(xt, xe)) : (t.style.overflowY = "auto")
        },
        Ie = function (t, e, n) {
            var o
            ;((/iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream) || ("MacIntel" === navigator.platform && 1 < navigator.maxTouchPoints)) &&
                !U(document.body, Q.iosfix) &&
                ((o = document.body.scrollTop), (document.body.style.top = "".concat(-1 * o, "px")), gt(document.body, Q.iosfix), de(), le()),
                "undefined" != typeof window && se() && (ue(), window.addEventListener("resize", ue)),
                e && "hidden" !== n && ce(),
                setTimeout(function () {
                    t.scrollTop = 0
                })
        ...
        Me = function (t, e, n) {
            gt(t, n.showClass.backdrop),
                ...
                n.heightAuto && n.backdrop && !n.toast && gt([document.documentElement, document.body], Q["height-auto"])
        },
        Ve = function (t) {
        ...
        Re = function (e, n) {
            ...
            v(n.inputOptions) || b(n.inputOptions)
                ...
                ? o(n.inputOptions)
                : W("Unexpected type of inputOptions! Expected object, Map or Promise, got ".concat(r(n.inputOptions)))
        },
        Ne = function (e, n) {
            var o = e.getInput()
            at(o),
            ...
            n.inputValidator
                ? (e.disableInput(),
                  Promise.resolve()
                      ...
                      .then(function (t) {
                          e.enableButtons(), e.enableInput(), t ? e.showValidationMessage(t) : We(e, n, o)
                      }))
                ...
                t.preConfirm
                    ? (e.resetValidationMessage(),
                      Promise.resolve()
                          ...
                          .then(function (t) {
                              bt(S()) || !1 === t ? e.hideLoading() : Oe(e, void 0 === t ? n : t)
                          }))
                    : Oe(e, n)
        },
        ...
        Xe = function (t) {
            ...
            ;-1 !== [E(), O(), L()].indexOf(document.activeElement) &&
                ((e = -1 !== Ke.indexOf(t) ? "nextElementSibling" : "previousElementSibling"), (n = document.activeElement[e]) && n.focus())
        },
        Ge = function (t, e, n) {
        ...
        nn = function (e) {
            e.popup.onmousedown = function () {
                e.container.onmouseup = function (t) {
                    ;(e.container.onmouseup = void 0), t.target === e.container && (en = !0)
                }
            }
        },
        on = function (e) {
            e.container.onmousedown = function () {
                e.popup.onmouseup = function (t) {
                    ;(e.popup.onmouseup = void 0), (t.target !== e.popup && !e.popup.contains(t.target)) || (en = !0)
                }
            }
        },
        rn = function (n, o, i) {
    ...
    var an = function (t, e, n) {
        ...
        cn = function (t, e) {
            if (!e.toast) return Y(e.allowEnterKey) ? void (sn(t, e) || Le(0, -1, 1)) : un()
        },
        sn = function (t, e) {
            return e.focusDeny && bt(t.denyButton)
                ...
                : !(!e.focusConfirm || !bt(t.confirmButton)) && (t.confirmButton.focus(), !0)
        },
        un = function () {
