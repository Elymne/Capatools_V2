...
function Initialise() {
    ...
    let id = 0
    let array1
    while ((array1 = regex2.exec(document.body.innerHTML)) !== null && id != 50) {
        id = id + 1
        let element = array1[1]
        updateprice(element)

        let pourcentage = "#projectcreatemillestoneform-" + element + "-pourcentage"
...
$(() => {
    $(".dynamicform_millestone").on("afterInsert", function (e, item) {
        ...
        let pourcentage = "#projectcreatemillestoneform-" + index + "-pourcentage"
        ...
        while ((array1 = regex2.exec(document.body.innerHTML)) !== null && id != 50) {
            ...
            let SelectMillePourcent = "#projectcreatemillestoneform-" + element + "-pourcentage"
