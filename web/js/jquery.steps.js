...
(function ($, undefined) {
        ...
        stepTitles.each(function (index) {
            var item = $(this), // item == header
                ...
                mode =
                    modeData == null
                        ? contentMode.html
                        : getValidEnumValue(contentMode, /^\s*$/.test(modeData) || isNaN(modeData) ? modeData : parseInt(modeData, 0)),
    ...
    function renderTitle(wizard, options, state, header, index) {
        var uniqueId = getUniqueId(wizard),
            ...
            stepItem = $(
                '<li role="tab"><a id="' + uniqueStepId + '" href="#' + uniqueHeaderId + '" aria-controls="' + uniqueBodyId + '">' + title + "</a></li>",
            );
